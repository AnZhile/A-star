...
import com.A_star.common.execption.A_starException;
import com.A_star.common.result.Result;
import com.A_star.common.result.ResultCodeEnum;

import com.A_star.common.utils.userUtil.AdminByStageSort;
import com.A_star.common.utils.other.MD5;
import com.A_star.model.memberDAO.Login;
import com.A_star.model.memberDAO.User;
import com.A_star.model.memberDAO.userVo.UserVo;
...
//            Collections.sort(userList, new AdminByStageSort());
    ...
    public Result getById(@PathVariable Long id) {
        try {
            ...
            throw new A_starException(201,"根据id获取学生失败");
        }
    ...
    public Result updateById(@RequestBody User user) {
        try {
            ...
            throw new A_starException(201,"修改失败");
        }
    }
    ...
    public Result remove(@PathVariable Long id) {
        try {
            ...
            throw new A_starException(201,"删除失败");
        }
    }
