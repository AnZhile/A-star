...
public interface AwadMapper extends BaseMapper<Award> {
    ...
    @Results({
            ...
            @Result(column = "id", property = "userNameList",
                    many = @Many(select = "com.atyuanchuang.member.mapper.GroupSelfMapper.getNameByGroupId"))
    })
    ...
    @Results({
            ...
            @Result(column = "group_name", property = "userNameList",
                    many = @Many(select = "com.atyuanchuang.member.mapper.GroupSelfMapper.getNameByGroupName"))
    })
